...
#Si alguien quiere desactivar la barra de progreso con forma de pacman y que vuelva a hacer "######" solo tiene que poner false el ILoveCandy 
__progressbar_theme() {
	[[ -z "${ILoveCandy}" ]] && ILoveCandy=true
